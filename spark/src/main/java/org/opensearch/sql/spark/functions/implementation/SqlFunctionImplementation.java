...
public class SqlFunctionImplementation extends FunctionExpression implements
   ...
   */
  public SqlFunctionImplementation(FunctionName functionName, List<Expression> arguments,
