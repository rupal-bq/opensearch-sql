...
package org.opensearch.sql.cloudwatch.functions.resolver;
...
import org.opensearch.sql.cloudwatch.functions.implementation.QueryRangeFunctionImplementation;
  ...
  public Pair<FunctionSignature, FunctionBuilder> resolve(FunctionSignature unresolvedSignature) {
    ...
    FunctionBuilder functionBuilder = (functionProperties, arguments) -> {
      ...
      if (argumentsPassedByPosition) {
        ...
        return new QueryRangeFunctionImplementation(functionName, namedArguments, cloudwatchClient);
      }
      return new QueryRangeFunctionImplementation(functionName, arguments, cloudwatchClient);
    };
